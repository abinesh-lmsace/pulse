...
/**
 * Get the list of soft dependencies for the session module.
 *
 * @return array List of soft dependencies.
 */
function pulsecondition_session_extend_softdepencencies() {
    return [
        'mod_facetoface' => 2021113000, // Dependencies set for the session module "Face to Face".
    ];
}
