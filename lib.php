...
function mod_pulse_inplace_editable($itemtype, $itemid, $newvalue) {
    ...
    if ($itemtype === 'templatetitle') {
        ...
        return new \core\output\inplace_editable('mod_pulse', 'title', $record->id, true,
            format_string($record->title), $record->title, get_string('edittemplatetitle', 'pulse'),
            get_string('newvaluefor', 'pulse', format_string($record->title)));
 ...
 *
 * @param array $params
 * @return string Output of the manage instance table
 */
